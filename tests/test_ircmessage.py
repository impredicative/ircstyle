...
class AttributeTests(IrcMessageTestCase):
    ...
    def test_bold_with_reset(self):
        ...
        self.assertEqual(message, '\x02Hello, world!\x01')
    ...
    def test_italics_with_reset(self):
        ...
        self.assertEqual(message, '\x1DHello, world!\x01')
    ...
    def test_underline_with_reset(self):
        ...
        self.assertEqual(message, '\x1FHello, world!\x01')
    ...
    def test_complex_attributes_with_reset(self):
        ...
        self.assertEqual(message, '\x02\x1d\x1fHello, world!\x01')
...
class ColorTests(IrcMessageTestCase):
    ...
    def test_fg_white(self):
        ...
        self.assertEqual(message, '\x0300Hello, world!\x01')
    ...
    def test_fg_black(self):
        ...
        self.assertEqual(message, '\x0301Hello, world!\x01')
    ...
    def test_fg_blue(self):
        ...
        self.assertEqual(message, '\x0302Hello, world!\x01')
    ...
    def test_fg_green(self):
        ...
        self.assertEqual(message, '\x0303Hello, world!\x01')
    ...
    def test_fg_red(self):
        ...
        self.assertEqual(message, '\x0304Hello, world!\x01')
    ...
    def test_fg_brown(self):
        ...
        self.assertEqual(message, '\x0305Hello, world!\x01')
    ...
    def test_fg_purple(self):
        ...
        self.assertEqual(message, '\x0306Hello, world!\x01')
    ...
    def test_fg_orange(self):
        ...
        self.assertEqual(message, '\x0307Hello, world!\x01')
    ...
    def test_fg_yellow(self):
        ...
        self.assertEqual(message, '\x0308Hello, world!\x01')
    ...
    def test_fg_lime(self):
        ...
        self.assertEqual(message, '\x0309Hello, world!\x01')
    ...
    def test_fg_teal(self):
        ...
        self.assertEqual(message, '\x0310Hello, world!\x01')
    ...
    def test_fg_aqua(self):
        ...
        self.assertEqual(message, '\x0311Hello, world!\x01')
    ...
    def test_fg_royal(self):
        ...
        self.assertEqual(message, '\x0312Hello, world!\x01')
    ...
    def test_fg_pink(self):
        ...
        self.assertEqual(message, '\x0313Hello, world!\x01')
    ...
    def test_fg_grey(self):
        ...
        self.assertEqual(message, '\x0314Hello, world!\x01')
    ...
    def test_fg_silver(self):
        ...
        self.assertEqual(message, '\x0315Hello, world!\x01')
    ...
    def test_bg(self):
        ...
        self.assertEqual(message, '\x0301,02Hello, world!\x01')
    ...
    def test_fg_and_bg(self):
        ...
        self.assertEqual(message, '\x0308,02Hello, world!\x01')
    ...
    def test_fg_and_bg_with_attributes(self):
        ...
        self.assertEqual(message, '\x0308,02\x02\x1fHello, world!\x01')
...
class UnstyleTests(IrcMessageTestCase):
    ...
    def test_unstyle_complex(self):
        message = '\x0308,02\x02\x1fHello, world!\x01'
